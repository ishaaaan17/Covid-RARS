...
def _write_training_progress(
    *,
    ...
    if pointer.get("writer") != "covid_audio_btp.hst_training._atomic_torch_save":
    ...
    expected_writer = "covid_audio_btp.hst_training._atomic_torch_save"
    if sidecar.get("writer") != expected_writer:
...
def _load_verified_checkpoint_pair(path: Path, sidecar_path: Path) -> dict[str, Any]:
    ...
    if sidecar.get("writer") != "covid_audio_btp.hst_training._atomic_torch_save":
...
def _evaluate_split_once(
    ...
    *,
    ...
    try:
        ...
        expected_writer = "covid_audio_btp.hst_training._evaluate_split_once"
        ...
        candidate_claim: dict[str, object] = {
            "schema_version": 2,
            "writer": "covid_audio_btp.hst_training._evaluate_split_once",
            "status": "claimed",
            "slot_id": slot_id,
        ...
        candidate_anchor: dict[str, object] = {
            "schema_version": 1,
            "writer": "covid_audio_btp.hst_training.slot_anchor",
            "status": "anchored",
            "slot_id": slot_id,
            "slot_identity": slot_identity,
        ...
        if (
            ...
            or anchor.get("writer") != "covid_audio_btp.hst_training.slot_anchor"
        ...
        if (
            ...
            or claim.get("writer") != expected_writer
