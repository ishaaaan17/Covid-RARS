...
`<repository>/covid_audio_btp` with `.venv` activated; test, script, source, and
report paths in those blocks therefore omit the leading `covid_audio_btp/`.
...
- Create: `covid_audio_btp/configs/hst_reliability.json`
- Create: `covid_audio_btp/requirements-hst.txt`
- Create after the Ubuntu pilot: `covid_audio_btp/requirements-hst-lock.txt`

**New modules**

- Create: `covid_audio_btp/src/covid_audio_btp/hst_data_contracts.py`
- Create: `covid_audio_btp/src/covid_audio_btp/hst_checkpoint.py`
- Create: `covid_audio_btp/src/covid_audio_btp/hst_comparators.py`
- Create: `covid_audio_btp/src/covid_audio_btp/hst_spectrograms.py`
- Create: `covid_audio_btp/src/covid_audio_btp/hst_protocols.py`
- Create: `covid_audio_btp/src/covid_audio_btp/hst_parallel.py`
- Create: `covid_audio_btp/src/covid_audio_btp/hst_training.py`
- Create: `covid_audio_btp/src/covid_audio_btp/hst_fusion.py`
- Create: `covid_audio_btp/src/covid_audio_btp/hst_reliability.py`
- Create: `covid_audio_btp/src/covid_audio_btp/hst_gradcam.py`
- Create: `covid_audio_btp/src/covid_audio_btp/hst_reporting.py`
- Create: `covid_audio_btp/src/covid_audio_btp/hst_runtime.py`

**New entry points**

- Create: `covid_audio_btp/scripts/hst_preprocess_worker.py`
- Create: `covid_audio_btp/scripts/72_run_hst_reliability.py`
- Create: `covid_audio_btp/scripts/73_make_hst_evidence_pack.py`
- Create: `covid_audio_btp/scripts/74_register_hst_evidence.py`
- Create: `covid_audio_btp/notebooks/09_HST_RELIABILITY_E2E.ipynb`

**New tests**

- Create: `covid_audio_btp/tests/hst_test_helpers.py`
- Create: `covid_audio_btp/tests/test_hst_data_contracts.py`
- Create: `covid_audio_btp/tests/test_hst_checkpoint.py`
- Create: `covid_audio_btp/tests/test_hst_comparators.py`
- Create: `covid_audio_btp/tests/test_hst_spectrograms.py`
- Create: `covid_audio_btp/tests/test_hst_protocols.py`
- Create: `covid_audio_btp/tests/test_hst_parallel.py`
- Create: `covid_audio_btp/tests/test_hst_training.py`
- Create: `covid_audio_btp/tests/test_hst_fusion.py`
- Create: `covid_audio_btp/tests/test_hst_reliability.py`
- Create: `covid_audio_btp/tests/test_hst_gradcam.py`
- Create: `covid_audio_btp/tests/test_hst_notebook.py`
...
- Cache: `covid_audio_btp/.cache/hst/checkpoints/`
- Cache: `covid_audio_btp/data/processed/hst_spectrogram_cache/<preprocessing_hash>/`
- Run root: `covid_audio_btp/data/outputs/hst/<run_id>/`
- Bootstrap root: `covid_audio_btp/data/outputs/hst/_bootstrap/<launch_id>/`
- Launch receipt: `covid_audio_btp/data/outputs/hst/_launches/<launch_id>.json`
...
- Validated publication pointer: `covid_audio_btp/reports/hst/latest.json`
...
git add src/covid_audio_btp/hst_data_contracts.py tests/hst_test_helpers.py tests/test_hst_data_contracts.py
...
- Create: `covid_audio_btp/configs/hst_reliability.json`
- Create: `covid_audio_btp/requirements-hst.txt`
- Test: `covid_audio_btp/tests/test_hst_checkpoint.py`

- [ ] **Step 1: Convert the existing clone to a pinned submodule**

```bash
# Run from the repository root, not from `covid_audio_btp/`.
mkdir -p covid_audio_btp/.cache/hst/checkpoints
cp HST/model/imagenet_weights/hst_small_imagenet.pth covid_audio_btp/.cache/hst/checkpoints/ 2>/dev/null || true
cp HST/model/imagenet_weights/hst_base_imagenet.pth covid_audio_btp/.cache/hst/checkpoints/ 2>/dev/null || true
...
```bash
# Run from the repository root, not from `covid_audio_btp/`.
git add .gitmodules HST covid_audio_btp/configs/hst_reliability.json covid_audio_btp/requirements-hst.txt covid_audio_btp/tests/test_hst_checkpoint.py
...
**Files:**
- Create: `covid_audio_btp/src/covid_audio_btp/hst_checkpoint.py`
- Modify: `covid_audio_btp/tests/test_hst_checkpoint.py`
...
```bash
git add src/covid_audio_btp/hst_checkpoint.py tests/test_hst_checkpoint.py
...
git add src/covid_audio_btp/hst_spectrograms.py scripts/hst_preprocess_worker.py tests/test_hst_spectrograms.py
...
def test_hst_folds_are_participant_disjoint() -> None:
    ...
    from covid_audio_btp.hst_protocols import build_protocol_matched_hst_manifest, audit_hst_manifest
...
def test_split_policy_manifests_share_cohort_counts_and_labels() -> None:
    ...
    from covid_audio_btp.hst_protocols import build_split_policy_contrast_manifests
...
def test_hst_task2_like_cohort_requires_cough_symptom_in_both_classes() -> None:
    ...
    from covid_audio_btp.hst_protocols import build_hst_task2_like_cough_manifest
...
def test_external_rows_never_enter_source_training() -> None:
    ...
    from covid_audio_btp.hst_protocols import build_external_hst_manifest
...
def test_protocols_change_manifest_not_scientific_configuration() -> None:
    ...
    from covid_audio_btp.hst_protocols import scientific_configuration_fingerprint
...
git add src/covid_audio_btp/hst_protocols.py tests/test_hst_protocols.py
...
def test_resume_continues_after_last_completed_epoch(tmp_path) -> None:
    ...
    from covid_audio_btp.hst_training import HSTTrainingConfig, train_hst_fold
...
git add src/covid_audio_btp/hst_training.py tests/test_hst_training.py
...
- Create: `covid_audio_btp/src/covid_audio_btp/hst_parallel.py`
- Create: `covid_audio_btp/tests/test_hst_parallel.py`
- Modify: `covid_audio_btp/tests/hst_test_helpers.py`
...
def test_preprocess_workers_reject_candidates_that_break_live_reserve() -> None:
    from covid_audio_btp.hst_parallel import ResourceSnapshot, choose_preprocess_workers
...
def test_single_gpu_queue_never_overlaps_training_jobs() -> None:
    ...
    from covid_audio_btp.hst_parallel import run_single_gpu_job_queue
...
def test_different_run_ids_cannot_share_one_gpu_uuid(tmp_path) -> None:
    from covid_audio_btp.hst_parallel import acquire_gpu_execution_lease
...
def test_loader_choice_does_not_use_model_metrics() -> None:
    ...
    from covid_audio_btp.hst_parallel import select_dataloader_workers
...
`$XDG_RUNTIME_DIR/covid_audio_btp/hst_gpu/<gpu_uuid>.lock` (or the same-user
...
git add src/covid_audio_btp/hst_parallel.py tests/test_hst_parallel.py
...
git add src/covid_audio_btp/hst_comparators.py tests/test_hst_comparators.py
...
def test_legacy_auprc_weights_are_validation_derived_and_normalized() -> None:
    ...
    from covid_audio_btp.hst_fusion import legacy_validation_auprc_weights
...
def test_primary_uniform_fusion_is_complete_case() -> None:
    ...
    from covid_audio_btp.hst_fusion import fuse_uniform_complete_case
...
git add src/covid_audio_btp/hst_fusion.py tests/test_hst_fusion.py
...
git add src/covid_audio_btp/hst_reliability.py src/covid_audio_btp/hst_runtime.py scripts/72_run_hst_reliability.py tests/test_hst_reliability.py
...
- Create: `covid_audio_btp/scripts/73_make_hst_evidence_pack.py`
- Create: `covid_audio_btp/scripts/74_register_hst_evidence.py`
- Modify: `covid_audio_btp/tests/test_hst_reliability.py`
...
def test_screening_threshold_is_fitted_on_validation_only() -> None:
    ...
    from covid_audio_btp.hst_reporting import (
...
Delegate calibration to the existing `covid_audio_btp.calibration.PlattCalibrator`
...
```bash
python -m pytest tests/test_hst_reliability.py -q
git add src/covid_audio_btp/hst_reporting.py scripts/73_make_hst_evidence_pack.py scripts/74_register_hst_evidence.py tests/test_hst_reliability.py
...
def test_gradcam_heatmap_is_finite_and_normalized() -> None:
    ...
    from covid_audio_btp.hst_gradcam import hst_gradcam
...
git add src/covid_audio_btp/hst_gradcam.py tests/test_hst_gradcam.py
...
**Files:**
- Create: `covid_audio_btp/reports/final/HST_EXECUTION_FREEZE.md`
