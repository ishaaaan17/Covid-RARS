...
def _authenticated_binding(
    ...
    from covid_audio_btp.hst_fusion import (
...
def _run_confirmatory_bank(
    ...
    from covid_audio_btp.hst_fusion import run_hst_fusion_bank
...
def test_four_branch_hybrid_rejects_cohort_or_fold_mismatch() -> None:
    from covid_audio_btp.hst_fusion import build_four_branch_hybrid_inputs
...
def test_fusion_result_rejects_any_export_table_without_analysis_hierarchy() -> None:
    from covid_audio_btp.hst_fusion import HSTFusionResult, run_hst_fusion_bank
...
def test_paired_delta_rejects_non_sha_comparison_binding() -> None:
    from covid_audio_btp.hst_fusion import _paired_delta_rows, run_hst_fusion_bank
...
def test_export_rejects_secondary_confirmatory_role_scope_pair() -> None:
    from covid_audio_btp.hst_fusion import HSTFusionResult
...
def test_direct_validation_weight_map_rejects_nonfinite_or_overflowed_totals(
    ...
    from covid_audio_btp.hst_fusion import ValidationWeightMap
...
def test_generation_export_failure_never_publishes_partial_current(
    ...
    import covid_audio_btp.hst_fusion as fusion_module
