...
def test_frequency_orientation_and_configuration_hash_are_frozen() -> None:
    from covid_rars.hst_spectrograms import HSTSpectrogramConfig, preprocessing_hash, waveform_to_hst_image
...
def test_cache_records_source_and_tensor_hashes(tmp_path: Path) -> None:
    ...
    from covid_rars.hst_spectrograms import HSTSpectrogramConfig, build_hst_spectrogram_cache
...
def test_three_channel_conversion_is_identical_and_normalized() -> None:
    ...
    from covid_rars.hst_spectrograms import HSTSpectrogramConfig, image_to_model_tensor
...
def test_preprocessing_claim_binds_native_process_identity_and_records_completion(
    ...
    from covid_rars.hst_runtime import capture_process_identity
    from covid_rars.hst_spectrograms import _acquire_preprocessing_claim
...
def test_cache_records_downstream_blocking_error_as_failure(
    ...
    from covid_rars import hst_spectrograms
    from covid_rars.hst_spectrograms import (
        HSTSpectrogramConfig,
        build_hst_spectrogram_cache,
    )
