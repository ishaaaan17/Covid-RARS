...
def test_capacity_config_is_a_distinct_twenty_job_internal_fusion_contract() -> None:
    ...
    from covid_rars.hst_workloads import workload_profile_from_scientific_config
...
def test_capacity_runtime_projection_is_bound_to_twenty_jobs() -> None:
    from covid_rars.hst_acceptance import _validate_conservative_runtime_projection
    from covid_rars.hst_resource_pilot import project_full_training_runtime
    from covid_rars.hst_workloads import CAPACITY_INTERNAL_FUSION_PROFILE
...
def test_capacity_workload_rejects_full_profile_modalities() -> None:
    from covid_rars.hst_stages import _frozen_runtime_projection_workload
    from covid_rars.hst_workloads import CAPACITY_INTERNAL_FUSION_PROFILE
...
def test_capacity_full_preprocessing_is_coswara_cough_and_speech_only() -> None:
    from covid_rars.hst_stages import _metadata_for_spectrogram_stage
    from covid_rars.hst_workloads import CAPACITY_INTERNAL_FUSION_PROFILE
