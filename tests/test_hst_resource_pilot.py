...
def test_timeout_failure_preserves_captured_worker_streams() -> None:
    ...
    from covid_rars.hst_resource_pilot import _worker_exception_result
...
def test_nonzero_worker_exit_preserves_structured_failure_evidence(
    ...
    from covid_rars.hst_resource_pilot import _read_worker_trial_result
...
def test_trial_runner_retains_nonzero_worker_payload(
    ...
    import covid_rars.hst_resource_pilot as resource_pilot
