...
REQUIRES_TORCH = pytest.mark.skipif(
    ...
    reason="Torch is optional and required only for executable HST training tests",
)
...
def test_manifest_stage_keeps_coughvid_out_of_all_source_training_manifests(
    ...
    import covid_rars.hst_protocols as protocols
    import covid_rars.hst_stages as stages
...
def test_aligned_comparator_manifest_unions_all_declared_contexts_once() -> None:
    import covid_rars.hst_stages as stages
    from covid_rars import hst_protocols
