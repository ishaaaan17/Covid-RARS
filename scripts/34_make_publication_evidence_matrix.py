...
from covid_rars.publication_evidence import build_publication_evidence_matrix, write_evidence_matrix
...
def default_input_paths(project_root: Path = Path(".")) -> dict[str, Path]:
    ...
    return {
        ...
        "domain_adaptation_baseline_metrics": metrics / "domain_adaptation_baseline_metrics.csv",
